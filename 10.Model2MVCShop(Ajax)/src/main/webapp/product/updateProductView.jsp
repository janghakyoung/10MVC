...
<%--
	...
	System.out.println("UPView.jsp 파일 vo : "+vo);
--%>
...
function fncupdateProduct() {
	...
	if(prodName == null || prodName.length <1){
		alert("상품이름은 반드시 입력하셔야 합니다.");
		return;
	}
	if(prodDetail == null || prodDetail.length <1){
		alert("자세한설명은  반드시 입력하셔야 합니다.");
		return;
	}
...
$(function() {
	$("td.ct_btn02:contains('취소')").bind("click",function(){
		resetData();
	});
});
...
<%-- System.out.println("<%=vo.getRegDate() 의 값 :"+${RegDate}; --%>
